...
/datum/techweb_node/podsadvancedprop
	id = "podsadvancedprop"
	display_name = "Advanced Pod Propulsion"
	description = "High speed propulsion for pods."
	prereq_ids = list("podsadvanced")
	design_ids = list("pengineplasmaadvanced","pengineuraniumadvanced","penginewoodadvanced")
