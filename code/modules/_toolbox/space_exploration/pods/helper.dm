...
/obj/pod
	...
	proc/CreateEnvironment(var/volume = 200)
		...
		air.set_moles(/datum/gas/oxygen, O2STANDARD*volume/(R_IDEAL_GAS_EQUATION*T20C))
		air.set_moles(/datum/gas/nitrogen, N2STANDARD*volume/(R_IDEAL_GAS_EQUATION*T20C))
		return air
