...
/obj/machinery/vending/percchef
	...
	req_access_txt = "561"
	refill_canister = /obj/item/vending_refill/percchef

	can_be_unfasten_wrench(mob/user, silent)
		return FAILED_UNFASTEN

/obj/machinery/vending/percchef/on_vend(atom/movable/AM)
	. = ..()
	if(GLOB.Perseus_Data["Perseus_Security_Systems"] && istype(GLOB.Perseus_Data["Perseus_Security_Systems"],/list))
		for(var/obj/machinery/computer/percsecuritysystem/percsec in GLOB.Perseus_Data["Perseus_Security_Systems"])
			percsec.gather_equipment(AM)


/obj/item/vending_refill/percchef
	machine_name = "PercTech Automated Chef"
...
/obj/machinery/vending/percmed
	...
	refill_canister = /obj/item/vending_refill/percmed

	can_be_unfasten_wrench(mob/user, silent)
		return FAILED_UNFASTEN

/obj/machinery/vending/percmed/on_vend(atom/movable/AM)
	. = ..()
	if(GLOB.Perseus_Data["Perseus_Security_Systems"] && istype(GLOB.Perseus_Data["Perseus_Security_Systems"],/list))
		for(var/obj/machinery/computer/percsecuritysystem/percsec in GLOB.Perseus_Data["Perseus_Security_Systems"])
			percsec.gather_equipment(AM)

/obj/item/vending_refill/percmed
	machine_name = "PercMed Plus"
...
/obj/machinery/vending/perctech
	...
	/obj/item/storage/box/matches = 5, /obj/item/grenade/plastic/x4/breach = 5, /obj/item/clothing/mask/cigarette/cigar/victory = 6)
...
/obj/machinery/vending/boozeomat/perc
	...
	refill_canister = /obj/item/vending_refill/percbooze
...
/obj/machinery/vending/boozeomat/perc/New()
	. = ..()
	name = "Perctech [name]"

/obj/item/vending_refill/percbooze
	machine_name = "perseus boozeomat"
