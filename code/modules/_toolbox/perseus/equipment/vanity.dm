...
/obj/item/lighter/perc/update_icon()
...
/obj/item/toy/syndicateballoon/percballoon
	name = "perseus balloon"
	desc = "$2.50. at your local Perseus gift shop."
	icon = 'icons/oldschool/perseus.dmi'
	icon_state = "percballoon"
	item_state = "percballoon"
