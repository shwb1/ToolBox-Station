...
/client/proc/cmd_admin_say(msg as text)
	...
	var/custom_asay_color = (CONFIG_GET(flag/allow_admin_asaycolor) && prefs.asaycolor) ? "<font color=[prefs.asaycolor]>" : "<font color='#ff72b8'>"
	...
	for(var/client/C in GLOB.admins)
		C << sound('sound/toolbox/adminsay.ogg',0,0,0,100)
