...
/client/proc/modify_canister_gas(obj/machinery/portable_atmospherics/canister/C)
	...
	var/gas_to_add = input(usr, "Choose a gas to modify.", "Choose a gas.") as null|anything in (subtypesof(/datum/gas))//(subtypesof(/datum/gas) - /datum/gas/unobtanium) //nice try
